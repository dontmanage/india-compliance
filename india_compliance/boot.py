...
from dontmanageerp.stock.get_item_details import sales_doctypes
...
def set_bootinfo(bootinfo):
    ...
    gst_settings = dontmanage.get_cached_doc("GST Settings").as_dict()
    ...
    bootinfo["ic_api_enabled_from_conf"] = bool(dontmanage.conf.ic_api_secret)

      ...
      <div class="main-content">
        ...
        <div class="card">
          ...
          <ul class="links">
            ...
            <a href="https://discuss.dontmanageerp.com/c/dontmanageerp/india-compliance/65"><li>Community Forum</li></a>
...
export default {
  ...
  methods: {
    ...
    showUsage() {
      ...
      dontmanage.set_route("List", "Integration Request");
    },
    logout() {
      dontmanage.confirm(
  ...
  computed: {
    ...
    valid_upto() {
      return dontmanage.datetime.str_to_user(this.subscriptionDetails.expiry_date);
    },

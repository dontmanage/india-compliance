...
class IndiaComplianceAccountPage {
    constructor(wrapper) {
        ...
        // which is required by dontmanage route in order to work it properly.
    ...
    setTitle() {
        dontmanage.utils.set_title(__("India Compliance Account"));
    }
    ...
    show() {
        ...
        $(dontmanage.pages[this.pageName]).on("show", () => {
            this.setTitle();
...
dontmanage.provide("india_compliance.pages");
india_compliance.pages.IndiaComplianceAccountPage = IndiaComplianceAccountPage;

dontmanage.provide("india_compliance.gst_api");

...
@parameterized_class(
    ...
    [
        ...
        ("Delivery Note",),
        ("Sales Invoice",),
        # TODO: Fix in DontManageErp
        # ("POS Invoice"),
    ],
)
class TestTransaction(DontManageTestCase):
    @classmethod
    def setUpClass(cls):
        dontmanage.db.savepoint("before_test_transaction")
        cls.is_sales_doctype = cls.doctype in SALES_DOCTYPES

    @classmethod
    def tearDownClass(cls):
        dontmanage.db.rollback(save_point="before_test_transaction")

    @classmethod
    def setUp(cls):
        cls.transaction_details = dontmanage._dict(doctype=cls.doctype)
    ...
    def test_transaction_with_gst_and_non_gst_items(self):
        ...
        append_item(doc, dontmanage._dict(item_code="_Test Non GST Item"))
    ...
    def test_transaction_for_items_with_duplicate_taxes(self):
        ...
        append_item(doc, dontmanage._dict(item_tax_template="GST 28% - _TIRC"))
    ...
    def test_validate_mandatory_gst_category(self):
        ...
        dontmanage.db.set_value("Address", address, "gst_category", "")
        ...
        dontmanage.db.set_value("Address", address, "gst_category", gst_category)
    ...
    def test_missing_hsn_code(self):
        ...
        # create item
        item_without_hsn = dontmanage.new_doc("Item")
    ...
    def test_validate_gst_category_unregistered(self):
        ...
        dontmanage.db.set_value("Address", address, "gst_category", "Unregistered")
        ...
        dontmanage.db.set_value("Address", address, "gst_category", "Registered Regular")
    ...
    def test_gst_category_with_invalid_regex(self):
        ...
        dontmanage.db.set_value("Address", address, "gst_category", "UIN Holders")
    ...
    def test_gst_category_without_gstin(self):
        ...
        dontmanage.db.set_value("Address", address, "gstin", "")
        ...
        dontmanage.db.set_value("Address", address, "gstin", gstin)
    ...
    def test_export_without_payment_of_gst(self):
        ...
        dontmanage.db.set_value("GST Settings", None, "enable_overseas_transactions", 1)
        ...
        dontmanage.db.set_value("GST Settings", None, "enable_overseas_transactions", 0)

    def test_reverse_charge_for_sales_transaction(self):
        if not self.is_sales_doctype:
            return

        dontmanage.db.set_value("GST Settings", None, "enable_reverse_charge_in_sales", 1)
        doc = create_transaction(
            **self.transaction_details,
            is_reverse_charge=1,
            is_in_state=True,
        ...
        dontmanage.db.set_value("GST Settings", None, "enable_reverse_charge_in_sales", 0)
...
class TestQuotationTransaction(DontManageTestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
...
def get_lead(first_name):
    if name := dontmanage.db.exists("Lead", {"first_name": first_name}):
        return name

...
from dontmanage.utils import add_to_date, getdate
...
class TestTransactionData(DontManageTestCase):
    @classmethod
    def setUpClass(cls):
        dontmanage.db.savepoint("before_test_transaction_data")

    @classmethod
    def tearDownClass(cls):
        dontmanage.db.rollback(save_point="before_test_transaction_data")
    ...
    def test_check_missing_address_fields(self):
        ...
        address = dontmanage.get_doc("Address", "_Test Registered Customer-Billing")
    ...
    def test_set_transaction_details(self):
        ...
        self.assertDictEqual(
            ...
            {
                "date": format_date(dontmanage.utils.today(), "dd/mm/yyyy"),
                "base_total": 100.0,

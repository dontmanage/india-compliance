...
def get_gstin_info(gstin):
    if (
        dontmanage.get_cached_value("User", dontmanage.session.user, "user_type")
        == "Website User"
    ):
        dontmanage.throw(_("Not allowed"), dontmanage.PermissionError)

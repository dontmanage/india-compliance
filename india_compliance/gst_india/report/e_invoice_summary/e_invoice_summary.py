...
def validate_filters(filters=None):
    ...
    if filters.from_date > filters.to_date:
        dontmanage.throw(_("From Date must be before To Date"), title=_("Invalid Filter"))


def get_data(filters=None):
    sales_invoice = dontmanage.qb.DocType("Sales Invoice")
    e_invoice_log = dontmanage.qb.DocType("e-Invoice Log")
    query = (
        dontmanage.qb.from_(sales_invoice)

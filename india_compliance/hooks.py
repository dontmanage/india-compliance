...
app_description = "DontManageErp app to simplify compliance with Indian Rules and Regulations"
app_icon = "octicon octicon-file-directory"
app_color = "grey"
app_email = "hello@indiacompliance.app"
app_license = "GNU General Public License (v3)"
required_apps = ["dontmanage/dontmanageerp"]
...
regional_overrides = {
    "India": {
        "dontmanageerp.controllers.taxes_and_totals.get_itemised_tax_breakup_header": "india_compliance.gst_india.overrides.transaction.get_itemised_tax_breakup_header",
        "dontmanageerp.controllers.taxes_and_totals.get_itemised_tax_breakup_data": (
            "india_compliance.gst_india.utils.get_itemised_tax_breakup_data"
        ),
        "dontmanageerp.controllers.taxes_and_totals.get_regional_round_off_accounts": "india_compliance.gst_india.overrides.transaction.get_regional_round_off_accounts",
        "dontmanageerp.accounts.party.get_regional_address_details": (
            "india_compliance.gst_india.overrides.transaction.update_party_details"
        ),
        "dontmanageerp.stock.doctype.item.item.set_item_tax_from_hsn_code": "india_compliance.gst_india.overrides.transaction.set_item_tax_from_hsn_code",
        "dontmanageerp.assets.doctype.asset.asset.get_depreciation_amount": (
...
audit_trail_doctypes = [
    ...
    "Accounts Settings",
    # DontManageErp DocTypes that make GL Entries
    "Dunning",
    "Invoice Discounting",
    "Journal Entry",
    "Payment Entry",
    ...
    # Additional DontManageErp DocTypes that constitute "Books of Account"
    "POS Invoice",
...
# 	"dontmanage.desk.doctype.event.event.get_events": "india_compliance.event.get_events"
# }
#
